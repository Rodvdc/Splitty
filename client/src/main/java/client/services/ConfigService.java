...
public class ConfigService {
    ...
    public String getServer() {
        try {
            ...
            System.out.println("Error. Switching to default server: localhost");
    ...
    public String getConfigLanguage() {
        try {
            ...
            System.out.println("Error. Switching to default language: English");
            return "english";
        }
    }
    ...
    public String getConfigCurrency() {
        try {
            ...
            System.out.println("Error. Switching to default currency: EUR");
            return "EUR";
        }
    }
    ...
    public String getEmail() {
        try {
            ...
            System.out.println("Error. No email available");
            return "";
        }
    }
    ...
    public String getPassword() {
        try {
            ...
            System.out.println("Error. No password available");
            return "";
        }
    }
    ...
    public void setConfigCurrency(String currency) {
        try {
            ...
            System.out.println("Error saving the currency.");
        }
    }
