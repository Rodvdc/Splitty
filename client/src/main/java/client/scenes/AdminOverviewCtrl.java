...
public class AdminOverviewCtrl implements Initializable {
    ...
    public void exportEvent() throws IOException {
        ...
        if (selected != null) {
            ...
            if (file == null) {
                System.err.println(map.get("saveError").toString());
                return;
            }
            file.createNewFile();
            try (PrintWriter writer = new PrintWriter(file)) {
                ...
                System.out.println(map.get("fileNotFound").toString());
            }
        } else {
            System.out.println(map.get("noEventSelected").toString());
        }
    }
    ...
    public void importEvent() {
        ...
        if (file == null) {
            System.out.println(map.get("noFileSelected").toString());
            return;
        }
